...
- If you identify review knowledge that should persist for follow-up implementers or reviewers (for example recurring defects, validation pitfalls, or environment caveats), record or update the workspace-local memory file at `./MEMORY.md` (the startup directory).
