...
- Reduce the normalized Source Brief to exactly three sections: Overview, Definition of Done, and Documentation Index.
...
- Prefer coverage and explicit ambiguity capture within those three sections over adding extra headings.
