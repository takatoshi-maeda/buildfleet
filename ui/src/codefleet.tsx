...
const SCREEN_TABS = ['releasePlan', 'document', 'board'] as const;
...
export default function CodefleetScreen({
  ...
  const [activeTab, setActiveTab] = useState<ScreenTab>('releasePlan');
  ...
  const isReleasePlanTabActive = activeTab === 'releasePlan';
          ...
          <View style={styles.mainArea}>
            ...
            <View style={styles.contentRow}>
              <View style={styles.boardContainer}>
                {isReleasePlanTabActive ? (
                  <ReleasePlanWorkspace client={client} />
                ) : isBoardTabActive ? (
                  <Board
                    client={client}
